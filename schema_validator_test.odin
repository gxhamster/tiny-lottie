...
"age": 20
	...
	valid_err := json_schema_validate_string_with_schema(test_schema_data1, schema)
	testing.expect_value(t, valid_err, JsonSchema_Validation_Error.None)
	valid_err1 := json_schema_validate_string_with_schema(test_schema_data2, schema)
	testing.expect_value(t, valid_err1, JsonSchema_Validation_Error.Minimum_Validation_Failed)
...
test_schema_data3 := `{}`
	...
	valid_err2 := json_schema_validate_string_with_schema(test_schema_data3, schema)
