...
lottie_enum_unmarshal_test :: proc(t: ^testing.T) {
  ...
  //)
  testing.expect(t, unmarshal_value(m["id"], mm) == LottieError.None, "Corrrect value for MatteMode enum")
  testing.expect(
    t,
    unmarshal_value(m["id1"], mm) == LottieError.UnmarshalOutOfBoundEnumValue,
...
json_lottie_test_prop_position_keyframe :: proc(t: ^testing.T) {
  m := json.Object {
    "t" = 23,
    "h" = 2,
    "i" = json.Object{"x" = json.Array{1, 2, 3}, "y" = json.Array{1, 2, 3}},
    "o" = json.Object{"x" = json.Array{2, 3, 4}, "y" = json.Array{2, 3, 4}},
    "s" = json.Array{5, 6},
...
"sa": {
  ...
  if err != .None {
    ...
    if err != .None {
      ...
      error := os.write_entire_file(FILE_NAME, transmute([]u8)builder_str)
